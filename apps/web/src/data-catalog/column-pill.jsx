...
// Pill is now stateless: click bubbles up via onProfile so the page
// can open the right-side ColumnProfileDrawer (one drawer for the
// whole page, not per-pill).

export function ColumnPill({ col, tableId, onProfile, flash, onFlashed }) {
