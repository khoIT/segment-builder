// Mock + demo data for Bedrock (ES module)
...
Object.assign(window, { GAMES, CONNECTORS, TABLES, FEATURES, MODELS, SEGMENTS, CAMPAIGNS, SEGMENT_SERIES, OVERLAP, DRIFT_ALERTS, RETENTION, FUNNEL, ARPU_SERIES, SAMPLE_ROWS });
