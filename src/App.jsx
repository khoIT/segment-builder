    ...
    <div style={{
      ...
      <div style={{ padding: '18px 20px 14px', borderBottom: `1px solid ${T.n200}` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: T.fSans, fontSize: 10, color: T.n500, marginTop: 2 }}>Player Hub · VNGGames</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: 12, borderTop: `1px solid ${T.n200}`, display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 10, color: T.n500 }}>linh.pham@vng.com.vn</div>
        </div>
...
export default function App() {
  ...
  React.useEffect(() => { if (window.lucide) window.lucide.createIcons(); }, [page, role, tweaks]);
